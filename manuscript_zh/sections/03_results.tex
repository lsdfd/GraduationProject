...
因此，图~\ref{fig:pol} 和图~\ref{fig:generalization} 支持的是同一个结论：本文的方法并非只对二阶微分有效，而是对应一条能够吸收通道要求、目标曲率、目标包络乃至目标支撑维度变化的统一 response-space 闭环。更完整的对比模型设置、评估维度与比较分析见补充材料第4节。
