# -*- coding: utf-8 -*-
"""
1000 nm 波段 k 空间传递函数扫描入口。

Usage
-----
  python src/infer/band_1000nm/imag_process/scan_kspace.py --sample 0
  python src/infer/band_1000nm/imag_process/scan_kspace.py --from_infer
"""
...
def main():
    parser = argparse.ArgumentParser(description="k 空间传递函数 2D 图 @ 1000 nm")
