...
Usage
-----
  python src/infer/band_1100nm/optimization.py
  python src/infer/band_1100nm/optimization.py --steps 200
"""
...
_DEFAULT_LAPLAS_ROOT = str(_ROOT / "samples" / "laplas_1100nm")
