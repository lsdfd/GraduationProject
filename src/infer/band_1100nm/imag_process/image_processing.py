...
Usage
-----
  python src/infer/band_1100nm/imag_process/image_processing.py
  python src/infer/band_1100nm/imag_process/image_processing.py --from_infer
"""
...
def main():
    parser = argparse.ArgumentParser(description="Fourier optics imaging simulation @ 1100 nm")
