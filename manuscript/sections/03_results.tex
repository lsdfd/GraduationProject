...
\begin{tabular}{>{\raggedright\arraybackslash}p{2.05cm}c>{\raggedleft\arraybackslash}p{1.2cm}>{\raggedright\arraybackslash}p{3.05cm}}
\toprule
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.86\linewidth]{../data/polarization_independent_scores/joint_top1_plots/lambda_1000.0nm_top1.png}

\vspace{0.5em}
\includegraphics[width=0.86\linewidth]{../data/polarization_multiplexed_scores/p_active_s_silent/p_active_s_silent_top5_plots/p_active_s_silent_lambda_1100.0nm_top5.png}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.86\linewidth]{../data/optica_lowpass_scores/tpp_mag_optica_lowpass_top5_plots/lambda_1050.0nm_top5.png}

\vspace{0.5em}
\includegraphics[width=0.86\linewidth]{../data/st2_template_match_20260330_233804/lambda_950nm/rank_001_sample_5409.png}
